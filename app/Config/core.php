...
Configure::write('Site.title', __('Portal: Naccess'));


Configure::write('Options.verified_org', array(
	'CSG' => 'CSG',
	'NSG' => 'NSG',
	'ISSO' => 'ISSO',
	'OTHER' => 'OTHER',
...
Configure::write('Dialogues.closing', __('Are you sure you want to close this NAC Exception? NAC Exceptions should only be closed after all actions have been completed and an Exception Form has been uploaded for ISSO review.'));
Configure::write('Dialogues.opening', __('Are you sure you want to open this NAC Exception? NAC Exceptions should only be open when you want it to be tracked. This is the default state when creating tracked NAC Exceptions.'));
Configure::write('Dialogues.deletecoc', __('Are you sure you want to delete this Exception Update entry? It cannot be undone, but a record of the action will be recorded and any attached file archived.'));
Configure::write('Dialogues.deleteequipment', __('Are you sure you want to delete this NAC Exception entry? It cannot be undone (and all coc\'s will be deleted), but a record of the action will be recorded and any attached file archived.'));
