<?php 
// File: app/View/ReviewStates/admin_edit.ctp
?>
<div class="top">
	<h1><?php echo __('Edit Review State'); ?></h1>
</div>
<div class="center">
	<div class="form">
		<?php echo $this->Form->create('ReviewState');?>
		    <fieldset>
		        <legend><?php echo __('Edit Review State'); ?></legend>
		    	<?php
					...
					echo $this->Form->input('notify_time', array(
						'label' => __('What time of day the Notification Email should be sent. (EST)'),
